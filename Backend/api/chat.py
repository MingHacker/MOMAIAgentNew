...
async def send_chat_message(
    ...
    try:
        ...
        Reply with short, emotionally supportive sentence, **and** try to keep the conversation going but try not to ask too many questions.
        or even get start the conversation.
